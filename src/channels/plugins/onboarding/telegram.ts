...
import { resolveDefaultTelegramAccountId, resolveTelegramAccount, } from "../../../telegram/accounts.js";
import { formatDocsLink } from "../../../terminal/links.js";
import { addWildcardAllowFrom } from "./helpers.js";
const channel = "telegram";
function normalizeTelegramAllowFromForDmPolicy(allowFrom, dmPolicy) {
    if (dmPolicy === "open") {
...
function setTelegramDmPolicy(cfg, dmPolicy) {
    const allowFrom = normalizeTelegramAllowFromForDmPolicy(cfg.channels?.telegram?.allowFrom, dmPolicy);
    return {
        ...cfg,
        channels: {
            ...cfg.channels,
...
function setTelegramDmPolicyForAccount(cfg, accountId, dmPolicy) {
...
async function promptTelegramAllowFrom(params) {
    ...
    const parseInput = (value) => value
        ...
        .filter(Boolean);
    const shouldSkipAllowlist = (value) => {
