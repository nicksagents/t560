...
function normalizeToolParametersForTool(
  tool: Tool<TSchema>,
...
export function normalizeToolParameters(
  ...
  return tools.map((tool) => normalizeToolParametersForTool(tool, options));
}
 ...
 */
export function cleanToolSchemaForGemini(tools: Tool<TSchema>[]): Tool<TSchema>[] {
