const DEFAULT_TAGLINE = "All your chats, one T560.";
...
const TAGLINES: string[] = [
  "Your terminal just powered up—type something and let the bot handle the busywork.",
  ...
  "Automation with power: minimal fuss, maximal throughput.",
  ...
  "Power on, commit in—let's ship something mildly responsible.",
  "I'll supercharge your workflow: fast, efficient, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.T560_TAGLINE_INDEX;
