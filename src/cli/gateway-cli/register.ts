...
import { dedupeBeacons, parseDiscoverTimeoutMs, pickBeaconHost, pickGatewayPort, } from "./discover.js";
...
export function registerGatewayCli(program) {
    const gateway = addGatewayRunCommand(program
        ...
        .addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.t560.ai/cli/gateway")}\n`));
