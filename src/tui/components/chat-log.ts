...
export class ChatLog extends Container {
  ...
  updateToolResult(
    ...
    if (opts?.partial) {
      existing.setPartialResult((result ?? undefined) as Record<string, unknown> | undefined);
      return;
    }
    existing.setResult((result ?? undefined) as Record<string, unknown> | undefined, {
