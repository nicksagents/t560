...
type PromptDefaultModelResult = { model?: string; config?: T560Config };
...
function resolveConfiguredModelRaw(cfg: T560Config): string {
...
function resolveConfiguredModelKeys(cfg: T560Config): string[] {
