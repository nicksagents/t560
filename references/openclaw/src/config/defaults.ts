...
import type { T560Config } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: T560Config): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: T560Config): T560Config {
...
export function applyTalkApiKey(config: T560Config): T560Config {
...
export function applyModelDefaults(cfg: T560Config): T560Config {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: T560Config): T560Config {
...
export function applyLoggingDefaults(cfg: T560Config): T560Config {
...
export function applyContextPruningDefaults(cfg: T560Config): T560Config {
